 ...
 * (1,1,1,0) -> p4
 */
static void unit_to (graphene_point3d_t * p1,
    ...
    math_helper_singular_value_decomposition (A, 4, 4, U, S, V);
    math_helper_singular_value_decomposition_solve (U, S, V, 4, 4, B, x);
